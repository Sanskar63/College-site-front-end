...
const TogetherWeGrow = () => {
  return (
    <div className="flex flex-col items-center py-12 bg-gray-100 px-4">
      <h1 className="text-3xl md:text-4xl font-bold text-center mb-4">
        Together We Grow
      </h1>
      <div className="w-[10%] h-1.5 bg-black rounded-full mb-8"></div>
      <p className="max-w-3xl text-center text-gray-700 leading-relaxed">
        At Indian Institute of Information Technology Una (IIIT Una), we believe in the power of collaboration and community. Our institute thrives on the collective efforts of our students, faculty, and partners, fostering an environment where innovation and learning flourish.
        <br /><br />
