    ...
    return (
        <div className='my-2'>
            ...
            <div className='w-[100%] mt-[2vw] flex flex-col items-center' >
                <div className='bg-rgba-dark-brown h-[24vh] sm:h-[21vw] w-[96vw] rounded-lg pt-[1vw] flex justify-center'>

                    <div className='w-[94vw] h-[20vh] sm:h-[17vw] flex items-center rounded-lg bg-rgba-cream'>
