...
function Announcement() {
  ...
  return (
    <div className='w-[100%] my-[2%]'>
      <h1 className='text-2xl md:text-4xl font-bold ml-[2%] underline'>This Week's Announcements</h1>
      {loading ? (
      ...
      <h1 className='text-2xl md:text-4xl font-bold ml-[2%] mt-10 underline'> All Previous Announcements</h1>
      {loading ? (
        <div className='flex flex-col items-center justify-center'>
